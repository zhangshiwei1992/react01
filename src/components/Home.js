    ...
    render() {
        return (
            <div>
                ...
                <img src={require('../assets/image/jianke.png')} style={{ width: '200px' }}></img>
                <img src="http://img3.imgtn.bdimg.com/it/u=1805197693,140239436&fm=26&gp=0.jpg" style={{ width: '200px' }}></img>
            </div>
        )
    }
}
